                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="username" type="text" class="form-control @error('fullname') is-invalid @enderror" name="username" value="{{ old('username') }}" required autocomplete="username" autofocus>
